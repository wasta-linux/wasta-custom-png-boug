...
# ==============================================================================
# wasta-custom-png-boug: wasta-custom-png-boug-postinst.sh
#
...
echo
echo "*** Beginning wasta-custom-png-boug-postinst.sh"
echo
...
echo
echo "*** Finished with wasta-custom-png-boug-postinst.sh"
echo
